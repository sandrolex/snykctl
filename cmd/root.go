...
var rootCmd = &cobra.Command{
	Use:   "snykctl",
	Short: "snyctl controls the Snyk api",
	Long: `snykctl is a client for the Snyk Api 
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.snykctl.yaml)")
